...
public class UserProfilePageCommonObjects {
	...
	private static Element removeProfilePhotoMessage = new Element("Your profile picture was removed",By.xpath("//span[@class='text-light' and text()='Your profile picture was removed.']"));
	...
	private static Element removeProfilePhoto = new Element("Remove profile photo",By.xpath("//app-profile-picture-changer//a[contains(text(),'Remove Photo ')]"));
	private static Element anonymousPhoto = new Element("Anonymous photo",By.xpath("//div[contains(@class,'header-avatar-top')]//img[@src='assets/img/anonymous.png']"));
	...
	public static class CropImageModal{
		...
		private static Element successfulMessage = new Element("Your profile picture was uploaded",By.xpath("//span[text()='Your profile picture was uploaded.']"));
