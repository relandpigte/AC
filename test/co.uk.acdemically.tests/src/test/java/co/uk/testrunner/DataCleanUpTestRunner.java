...
@CucumberOptions(features = "src/test/java/co/uk/features", plugin = { "pretty",
		"html:target/cucumberHtmlReport", "html:target/cucumberHtmlReport", // html result
		...
		"com.vimalselvam.cucumber.listener.ExtentCucumberFormatter:target/extentreport/report.html" }, monochrome = true, glue = {
				"co.uk.stepdefinitions" }, tags = { "@DataCleanUp" })
...
public class DataCleanUpTestRunner extends AbstractTestNGCucumberTests {
