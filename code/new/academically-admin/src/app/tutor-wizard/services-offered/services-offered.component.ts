...
export class ServicesOfferedComponent extends AppComponentBase {
  ...
  constructor(
    ...
    this._becomeATutorService.currentTutorWizardStep$
      ...
      if (this.isReadOnly && this.tutorVerificationStep.step !== BecomeATutorStep.ServicesOffered) {
        this._tutorApplicationService.getStep(step.tutorVerificationId, BecomeATutorStep.ServicesOffered).subscribe(result => {
