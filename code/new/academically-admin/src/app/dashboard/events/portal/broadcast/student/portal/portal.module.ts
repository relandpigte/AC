...
import { HandoutCardComponent } from './_components/handouts/_components/handout-card.component';
...
import { UserRemovedComponent } from './_components/user-removed/user-removed.component';
...
@NgModule({
  declarations: [
    ...
    PollComponent,
    HandoutsComponent,
    HandoutCardComponent,
    ChatComponent,
    CommentsComponent,
    LiveQuestionCardComponent,
    UserRemovedComponent,
  ],
  imports: [
    CommonModule,
    PortalRoutingModule,
