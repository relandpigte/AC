...
import { CreateCoachingResourceDto, CoachingResourcesServiceProxy, FileParameter, DocumentType, CoachingResourceType } from '@shared/service-proxies/service-proxies';
...
export class UploadHandoutComponent extends AppComponentBase implements OnInit {
  ...
  onFormSubmit(): void {
    ...
    this.model.type = CoachingResourceType.Handout;
