...
import { CourseDto, CourseDtoPagedResultDto, CoursesServiceProxy, DateGrains, PostsServiceProxy, ServicesServiceProxy } from '@shared/service-proxies/service-proxies';
