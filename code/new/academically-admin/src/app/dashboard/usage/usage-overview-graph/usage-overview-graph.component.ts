...
@Component({
  selector: 'app-usage-overview-graph',
  templateUrl: './usage-overview-graph.component.html',
  styleUrls: ['./usage-overview-graph.component.less']
})
export class UsageOverviewGraphComponent implements OnInit {
