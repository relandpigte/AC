...
export class VerificationsComponent extends AppComponentBase implements OnInit {
  ...
  onVerifyMobileNumberClick(): void {
    const modalSettings = this.defaultModalSettings as ModalOptions<MobileVerificationComponent>;
    modalSettings.class = 'modal-md';
    const modal = this._modalService.show(MobileVerificationComponent, modalSettings).content;
  ...
  onVerifiyPassportClick(): void {
    ...
    const modalRef = this._modalService.show(PassportVerificationComponent, modalSettings);
    const modal: PassportVerificationComponent = modalRef.content;
