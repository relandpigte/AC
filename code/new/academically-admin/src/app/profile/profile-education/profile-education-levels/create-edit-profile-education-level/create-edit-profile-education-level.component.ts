...
@Component({
  selector: 'app-create-edit-profile-education-level',
  templateUrl: './create-edit-profile-education-level.component.html',
  styleUrls: ['./create-edit-profile-education-level.component.less']
})
export class CreateEditProfileEducationLevelComponent implements OnInit {
