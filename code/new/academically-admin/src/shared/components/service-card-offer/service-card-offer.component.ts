...
@Component({
  selector: 'app-service-card-offer',
  templateUrl: './service-card-offer.component.html',
  styleUrls: ['./service-card-offer.component.less']
})
export class ServiceCardOfferComponent extends AppComponentBase {
