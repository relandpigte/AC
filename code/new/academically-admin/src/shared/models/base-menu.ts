...
export abstract class BaseMenu extends AppComponentBase {
  ...
  protected getMenuItems(): MenuItem[] {
    return [
      ...
      new MenuItem(this.l('Community'), '/app/community', 'fe fe-home', 'Pages.Community'),
      new MenuItem(this.l('Dashboard'), '', 'fe fe-home', 'Pages.Dashboard', [
        ...
        new MenuItem(this.l('Workshop'), '/app/dashboard/workshop', 'fe fe-clipboard', 'Pages.Dashboard.Workshop'),
