...
namespace Academically.Authorization
{
    public class AcademicallyAuthorizationProvider : AuthorizationProvider
    {
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            profileIntoductionPermission.CreateChildPermission(PermissionNames.Pages_Profile_Introduction_Video, L("Metrics"));
            ...
            var videosPermission = context.CreatePermission(PermissionNames.Pages_Videos, L("Videos"));
            videosPermission.CreateChildPermission(PermissionNames.Pages_Videos_TutorPortal, L("TutorPortal"));
            videosPermission.CreateChildPermission(PermissionNames.Pages_Videos_StudentPortal, L("StudentPortal"));


            var articlesPermission = context.CreatePermission(PermissionNames.Pages_Articles, L("Articles"));
            articlesPermission.CreateChildPermission(PermissionNames.Pages_Articles_TutorPortal, L("TutorPortal"));
