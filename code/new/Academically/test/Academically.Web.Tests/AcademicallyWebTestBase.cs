...
{
    public abstract class AcademicallyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AcademicallyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AcademicallyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AcademicallyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AcademicallyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AcademicallyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AcademicallyDbContext, Task<T>> func)
        {
            T result;
