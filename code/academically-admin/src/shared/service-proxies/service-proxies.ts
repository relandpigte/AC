...
export class UserServiceProxy {
    ...
    getUserTwoFactorAuthenticationStatus(userId: number | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/User/GetUserTwoFactorAuthenticationStatus?";
        if (userId === null)
     ...
     * @return Success
     */
    getUserTwoFactorAuthentication(userId: number | undefined): Observable<EnableAuthenticatorModelDto> {
        let url_ = this.baseUrl + "/api/services/app/User/GetUserTwoFactorAuthentication?";
        if (userId === null)
            throw new Error("The parameter 'userId' cannot be null.");
        else if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<EnableAuthenticatorModelDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<EnableAuthenticatorModelDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetUserTwoFactorAuthentication(response: HttpResponseBase): Observable<EnableAuthenticatorModelDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EnableAuthenticatorModelDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<EnableAuthenticatorModelDto>(<any>null);
    }
     ...
     * @return Success
     */
    enableUserTwoFactorAuthentication(userId: number | undefined, code: string | null | undefined): Observable<EnableAuthenticatorModelDto> {
        let url_ = this.baseUrl + "/api/services/app/User/EnableUserTwoFactorAuthentication?";
        if (userId === null)
            throw new Error("The parameter 'userId' cannot be null.");
        else if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
    ...
    protected processEnableUserTwoFactorAuthentication(response: HttpResponseBase): Observable<EnableAuthenticatorModelDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    disableUserTwoFactorAuthentication(userId: number | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/User/DisableUserTwoFactorAuthentication?";
        if (userId === null)
            throw new Error("The parameter 'userId' cannot be null.");
        else if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
     ...
     * @return Success
     */
    loadSharedKeyAndQrCodeUri(body: User | undefined): Observable<EnableAuthenticatorModelDto> {
        let url_ = this.baseUrl + "/api/services/app/User/LoadSharedKeyAndQrCodeUri";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processLoadSharedKeyAndQrCodeUri(response: HttpResponseBase): Observable<EnableAuthenticatorModelDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class EnableAuthenticatorModelDto implements IEnableAuthenticatorModelDto {
    ...
    constructor(data?: IEnableAuthenticatorModelDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): EnableAuthenticatorModelDto {
        data = typeof data === 'object' ? data : {};
        let result = new EnableAuthenticatorModelDto();
        result.init(data);
        return result;
    }
    ...
    clone(): EnableAuthenticatorModelDto {
        const json = this.toJSON();
        let result = new EnableAuthenticatorModelDto();
        result.init(json);
        return result;
...
export interface IEnableAuthenticatorModelDto {
    sharedKey: string | undefined;
    authenticationUri: string | undefined;
    recoveryCode: string[] | undefined;
    statusMessage: string | undefined;
