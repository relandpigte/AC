...
export class AppAuthService {
  ...
  login(accessToken: string, encryptedAccessToken: string, expireInSeconds: number, rememberMe?: boolean): void {
  ...
  private processAuthenticateResult(authenticateResult: AuthenticateResultModel) {
    ...
    if (authenticateResult.isTwoFactorEnabled) {
      const params = [
        { accessToken: authenticateResult.accessToken },
        { encryptedAccessToken: authenticateResult.encryptedAccessToken },
        { expireInSeconds: authenticateResult.expireInSeconds },
        { userId: authenticateResult.userId },
        { rememberMe: this.rememberMe }
      ];
      this._router.navigate(['account/two-factor-authentication'], {
        queryParams: {
